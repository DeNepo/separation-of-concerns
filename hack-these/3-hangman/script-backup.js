debugger; // when the script is loaded, before the whole page is ready

// check the window object in your debugger
//  it's .onload property is about to be assigned
window.onload = function () {
  debugger; // when the entire window has finished loading
  ...
  // Play
  play = function () {
    debugger; // each time the game begins
  ...
  hint.onclick = function () {
    debugger; // each time a user asks for a hint
  ...
  document.getElementById('reset').onclick = function () {
    debugger; // each time a user resets the game
